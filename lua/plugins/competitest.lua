return {
    ...
    config = function()
        require("competitest").setup({
            ...
            compile_directory = ".",
            compile_command = {
                c = { exec = "gcc", args = { "-DLOCAL", "-Wall", "$(FNAME)", "-o", "$(FNOEXT)" } },
            ...
            template_file = {
                cpp = "~/templates/init.cpp",
                py = "~/templates/init.py",
            },
        ...
        vim.keymap.set("n", "<leader>rr", "<cmd>CompetiTest run<CR>", { desc = "Run test cases" })
        vim.keymap.set("n", "<leader>ra", "<cmd>CompetiTest add_testcase<CR>", { desc = "Add a testcase" })
        vim.keymap.set("n", "<leader>re", "<cmd>CompetiTest edit_testcase<CR>", { desc = "Edit testcases" })
        vim.keymap.set("n", "<leader>rd", "<cmd>CompetiTest delete_testcase<CR>", { desc = "Delete testcase" })
        vim.keymap.set(
            "n",
            "<leader>ri",
            "<cmd>CompetiTest receive testcases<CR>",
            { desc = "Receive testcases from contest" }
        )
        vim.keymap.set(
            "n",
            "<leader>rp",
